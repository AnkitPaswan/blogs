      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 md:py-12 
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-3 leading-relaxed">
            ...
            (formerly “BLOGS Advisory Services <br className="hidden sm:block" /> Private Limited”)
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 text-sm">
            <li className="hover:text-indigo-600 transition cursor-pointer">Privacy Policy</li>
            <li className="hover:text-indigo-600 transition cursor-pointer">Terms of Use</li>
            <li className="hover:text-indigo-600 transition cursor-pointer">Cancellation Policy</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 text-sm">
            ...
            <li className="hover:text-indigo-600 transition cursor-pointer">What's New</li>
